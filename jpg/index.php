...
<div align="center">
	...
	<table width="980" border="0" cellpadding="0" cellspacing="0">
	  <tr>
	    <td colspan="3" align="left" valign="top" background="jpg/bot.png"><iframe name="box01" width="971" height="357" marginwidth="1" marginheight="1" scrolling="no" border="0" frameborder="0" src="news.htm" align="right"> 您的瀏覽器不支援內置框架或目前的設定為不顯示內置框架。</iframe></td>
      </tr>
	  <tr>
	    <td colspan="3" align="center" valign="top" background="jpg/bot.png"><p><img src="jpg/graydown.png" width="961" height="9"></p>
	      <!----------活動列表-------------->
	      <table width="850">
	<tr>
    	<td align="center" style="color:#333333; font-size:9pt" width="740">
        	<a style="border:0; color:#333333; font-size:11pt; cursor:pointer" id="hot1" href="#hot"><b>熱門精選</b></a>&nbsp;&nbsp;|&nbsp;&nbsp;
        ...
        <td align="right" style="color:#666666; font-size:10pt; border:1px solid #cccccc;"><b><a onClick="window.open('activities/share.php','','menubar=no,status=no,scrollbars=no,top=200,left=200,toolbar=no,width=925,height=546')" style="border:0; cursor:pointer">分享新活動</a>&nbsp;+</b></td>
    </tr>
    <tr>
    ...
    <tr>
		...
		echo '
        	<table background="jpg/table.jpg" style="background-repeat:no-repeat">
            	<tr>
                	<td rowspan="7" class="tdimg" height="224" width="38%" align="center" valign="middle"><img class="img" src="activities/poster/'.$hotlist['poster'].'" /></td>
    ...
    <tr>
		...
		echo '
        	<table background="jpg/table.jpg" style="background-repeat:no-repeat">
            	<tr>
                	<td rowspan="7" class="tdimg" height="224" width="38%" align="center" valign="middle"><img class="img" src="activities/poster/'.$clubslist["poster"].'" /></td>
					<td rowspan="7" width="80px"></td>
					...
					if($_SESSION['stu_id'] == $clubslist['stu_id']){
						...
						echo '
							<td align="center" width="115" rowspan="2" style="font-size:14px"><form action="page/airstab/app/apply/apply02.php" method="get" target="foo" onSubmit="window.open(\'\',\'foo\',\'menubar=no,status=no,scrollbars=no,top=200,left=200,toolbar=no,width=900,height=700\')"><input type="hidden" name="rno" value="'.$clubslist['rno'].'" /><input type="submit"  /></form>&nbsp;&nbsp;&nbsp;&nbsp;<script language="javascript">var now=new Date();var spday=new Date('.$year.','.$month.'-1,'.$day.');a=(spday.getTime()-now.getTime())/(24*60*60*1000);a=Math.ceil(a); if(a<0){document.write("<b>0</b>");} else {document.write("<b>"+a+"</b>");}</script></td>';
					}
    ...
    <tr>
		...
		echo '
        	<table background="jpg/table.jpg" style="background-repeat:no-repeat">
            	<tr>
                	<td rowspan="7" class="tdimg" height="224" width="38%" align="center" valign="middle"><img class="img" src="activities/poster/'.$departmentslist["poster"].'" /></td>
					<td rowspan="7" width="80px"></td>
    ...
    <tr>
		...
		echo '
        	<table background="jpg/table.jpg" style="background-repeat:no-repeat">
            	<tr>
                	<td rowspan="7" class="tdimg" height="224" width="38%" align="center" valign="middle"><img class="img" src="activities/poster/'.$authoritieslist["poster"].'" /></td>
					<td rowspan="7" width="80px"></td>
    ...
    <tr>
		...
		echo '
        	<table background="jpg/table.jpg" style="background-repeat:no-repeat">
            	<tr>
                	<td rowspan="7" class="tdimg" height="224" width="38%" align="center" valign="middle"><img class="img" src="activities/poster/'.$concertslist["poster"].'" /></td>
					<td rowspan="7" width="80px"></td>
