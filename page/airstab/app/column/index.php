...
$all = mysqli_query($conn, 'SELECT * FROM `Col` WHERE shelf = "article"');
...
while($topall = mysqli_fetch_array($top)){
	if($topall["class"] == "column" && $a == 1){
		$topcol = '<a target="_top" href="read.php?rno='.$topall['rno'].'">';
			if($topall["front"] != ""){
				$topcol = $topcol.'<img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="349px" height="232px" />';
			}
			else {
				$topcol = $topcol.'<img border="0" src="jpg/p1.jpg" width="349px" height="232px" />';
			}
	...
	elseif($topall["class"] == "food" && $b == 1){
		$topfood = '<a target="_top" href="read.php?rno='.$topall['rno'].'">';
			if($topall["front"] != ""){
				$topfood = $topfood.'<img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="349px" height="232px" />';
			}
			else {
				$topfood = $topfood.'<img border="0" src="jpg/p1.jpg" width="349px" height="232px" />';
			}
	...
	elseif($topall["class"] == "school" && $c == 1){
		$topsch = '<a target="_top" href="read.php?rno='.$topall['rno'].'">';
			if($topall["front"] != ""){
				$topsch = $topsch.'<img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="349px" height="232px" />';
			}
			else {
				$topsch = $topsch.'<img border="0" src="jpg/p1.jpg" width="349px" height="232px" />';
			}
	...
	elseif($topall["class"] == "concerts" && $d == 1){
		$topcon = '<a target="_top" href="read.php?rno='.$topall['rno'].'">';
			if($topall["front"] != ""){
				$topcon = $topcon.'<img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="349px" height="232px" />';
			}
			else {
				$topcon = $topcon.'<img border="0" src="jpg/p1.jpg" width="349px" height="232px" />';
			}
	...
	elseif($topall["class"] == "column" && $a == 2){
		if($topall["front"] != "") {
			$secondcol = $secondcol.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="161px" height="104px"></a>';
		}
		else
			$secondcol = $secondcol.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="jpg/p1.jpg" width="161px" height="104px"></a>';			$secondcol = $secondcol.' <div class="othertitle"><h3><a href="read.php?rno='.$topall['rno'].'" title="'.$topall['title'].'">'.$topall['title'].'</a></h3><div class="maskCss" style="height: 50px; opacity: 0.6; "></div></div>';
		$a++;
	}
	
	elseif($topall["class"] == "food" && $b == 2){
		if($topall["front"] != "") {
			$secondfood = $secondfood.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="161px" height="104px"></a>';
		}
		else
			$secondfood = $secondfood.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="jpg/p1.jpg" width="161px" height="104px"></a>';			$secondfood = $secondfood.' <div class="othertitle"><h3><a href="read.php?rno='.$topall['rno'].'" title="'.$topall['title'].'">'.$topall['title'].'</a></h3><div class="maskCss" style="height: 50px; opacity: 0.6; "></div></div>';
		$b++;
	}
	
	elseif($topall["class"] == "school" && $c == 2){
		if($topall["front"] != "") {
			$secondsch = $secondsch.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="161px" height="104px"></a>';
		}
		else
			$secondsch = $secondsch.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="jpg/p1.jpg" width="161px" height="104px"></a>';			$secondsch = $secondsch.' <div class="othertitle"><h3><a href="read.php?rno='.$topall['rno'].'" title="'.$topall['title'].'">'.$topall['title'].'</a></h3><div class="maskCss" style="height: 50px; opacity: 0.6; "></div></div>';
		$c++;
	}
	
	elseif($topall["class"] == "concerts" && $d == 2){
		if($topall["front"] != "") {
			$secondcon = $secondcon.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="161px" height="104px"></a>';
		}
		else
			$secondcon = $secondcon.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="jpg/p1.jpg" width="161px" height="104px"></a>';			$secondcon = $secondcon.' <div class="othertitle"><h3><a href="read.php?rno='.$topall['rno'].'" title="'.$topall['title'].'">'.$topall['title'].'</a></h3><div class="maskCss" style="height: 50px; opacity: 0.6; "></div></div>';
		$d++;
	}
	
	elseif($topall["class"] == "column" && $a==3){
		if($topall["front"] != "") {
			$thirdcol = $thirdcol.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="161px" height="104px"></a>';
		}
		else
			$thirdcol = $thirdcol.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="jpg/p1.jpg" width="161px" height="104px"></a>';
	...
	elseif($topall["class"] == "food" && $b==3){
		if($topall["front"] != "") {
			$thirdfood = $thirdfood.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="161px" height="104px"></a>';
		}
		else
			$thirdfood = $thirdfood.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="jpg/p1.jpg" width="161px" height="104px"></a>';
	...
	elseif($topall["class"] == "school" && $c==3){
		if($topall["front"] != "") {
			$thirdsch = $thirdsch.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="161px" height="104px"></a>';
		}
		else
			$thirdsch = $thirdsch.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="jpg/p1.jpg" width="161px" height="104px"></a>';
	...
	elseif($topall["class"] == "concerts" && $d==3){
		if($topall["front"] != "") {
			$thirdcon = $thirdcon.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="../../../../accounts/images/'.$topall["stu_id"].'/col/'.$topall["front"].'" width="161px" height="104px"></a>';
		}
		else
			$thirdcon = $thirdcon.'<a href="read.php?rno='.$topall["rno"].'"><img border="0" src="jpg/p1.jpg" width="161px" height="104px"></a>';
