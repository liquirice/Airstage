										...
										<table border="0" width="892" cellpadding="5">
											<tr>
													...
													<tr>
														<td style="border: 1px solid #C0C0C0" valign="top" align="center">
															...
															<a target="_top" href="read.php?rno=<?php echo ''.$topsch['rno'].''; ?>">
																<?php
																if($topsch["front"] != ""){
																	echo '<img border="0" src="../../../../accounts/images/'.$topsch["stu_id"].'/col/'.$topsch["front"].'" width="349" height="232" />';
																}
																else {
												...
												while($school = mysqli_fetch_array($sch)){
													echo '● <a style="color:#666666" style="font-size:9pt;" href="read.php?rno='.$school['rno'].'">'.$school['title'].'</a><br>';
												}
