...
$col = mysqli_query($conn, 'SELECT * FROM `Col` WHERE class = "column" ORDER BY uploadtime DESC');
?>
<!DOCTYPE HTML>
                                	...
                                	<?php
                                		while($colresult = mysqli_fetch_array($col)){
	                                		...
	                                		<tr>
	                                			...
	                                			<td width='137px' height='18px' style='font-size:11px; color:#777777'>".$colmember["name"]."/".$colmember["department"]."".$colmember["grade"]."級</td>
	                                		</tr>
	                                		<tr>
	                                			<td colspan='2' width='394px'style='font-size:11px; line-height:2;'>".$short."...</td>
	                                		</tr>
	                                		<tr>
	                                			<td><div class='fb-like' data-href='http://www.airstage.com.tw/nsysu/airs/page/airstab/app/column/read.php?rno=".$colresult["rno"]."' data-send='false' data-width='50' data-layout='button_count' data-show-faces='true'></div></td>
	                                		</tr>
	                                		</table>";
                                		}
                                	?>
