												...
												<table border="0" width="359" cellspacing="0" cellpadding="0">
													<tr>
														<td style="border: 1px solid #C0C0C0" valign="top" align="center">
															...
															<div class="desc">
																<p><span style="color:#FFF"><?php echo left_string($topcon['realcontent'],15,"..."); ?></span><a href="read.php?rno=<?php echo ''.$topcon['rno'].''; ?>" target="_blank" style="cursor:pointer">更多»</a></p>
															</div>
                                                            </div></p>
        												</td>
													</tr>
