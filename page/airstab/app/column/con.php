										...
										<table border="0" width="892" cellpadding="5">
											<tr>
													...
													<tr>
														<td style="border: 1px solid #C0C0C0" valign="middle" align="center" height="240px">
															...
															<a target="_top" href="read.php?rno=<?php echo ''.$topcon['rno'].''; ?>">
																<?php
																if($topcon["front"] != ""){
																	echo '<img border="0" src="../../../../accounts/images/'.$topcon["stu_id"].'/col/'.$topcon["front"].'" width="349px" height="232px" />';
																}
																else {
												...
												while($concerts = mysqli_fetch_array($con)){
													echo '● <a style="color:#666666" style="font-size:9pt;" href="read.php?rno='.$concerts['rno'].'">'.CuttingStr($concerts['title'],30).'</a><br>';
												}
