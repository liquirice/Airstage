...
<body background="jpg/bg.png">

<?php
if($_SESSION['name'] == ''){
echo '
<form method="post" action="submit.php?type=signup">
<table align="center" background="jpg/box.png" style="background-repeat:no-repeat" width="846" height="606">
...
<table style="font-size:14px" height="98%">
    ...
    <tr>
    	<td colspan="2"  align="center" valign="bottom" height="109"><input type="submit" style="background-image:url(jpg/botton.jpg); background-repeat:no-repeat; width:138px; height:55px; border:none; cursor:pointer" value="" />
    </table>
</td>
</tr>
</table>
