...
$col = mysqli_query($conn, 'SELECT * FROM `Col` WHERE class = "food" AND shelf = "article" ORDER BY uploadtime DESC');
...
<head>
    ...
    <title><?php if($count!=0) echo "(".$count.")" ?> 食尚指南 ─ Airstage 西灣人</title>
                        ...
                        <tr>
	                        <td colspan='5' width='608px' align="center">
                                ...
                                <div style="width:90px; float: left; font-size: 16px; border: 1px solid; border-radius: 7px; color: #666666; border-color: #CCCCCC" id="type">
                                    <br /><a id="food">美食</a><br /><br />
                                    <a id="desti">景點</a><br /><br />
                                </div>
	                        	<div id="block" style="float: right">
                                	<?php
                                	$arr = array('美食' =>"food" , "景點"=>"desti");
