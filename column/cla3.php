...
$col = mysqli_query($conn, 'SELECT * FROM `Col` WHERE class = "school" AND shelf = "article" ORDER BY uploadtime DESC');
...
<head>
    ...
    <title><?php if($count!=0) echo "(".$count.")" ?> 校園話題 ─ Airstage 西灣人</title>
    <script type="text/javascript"> 
    var coltype = "schselect";
	var app = "column";
	// 背景區塊的透明度
    var _opacity = .6;
    $(function(){
                        ...
                        <tr>
	                        <td colspan='5' width='608px' align="center">
                                ...
                                <div style="width:90px; float: left; font-size: 16px; border: 1px solid; border-radius: 7px; color: #666666; border-color: #CCCCCC" id="type">
                                    <br/><a id="schoolnews">校園議題</a><br /><br />
                                    <a id="exam">升學考試</a><br /><br />
                                    <a id="exchange">交換留學</a><br /><br />
                                    <a id="knowledge">推薦知識</a><br /><br />
                                    <a id="story">西灣故事</a><br /><br />
                                    <a id="clubsevent">社團活動</a><br /><br />
                                    <a id="work">工讀實習</a><br /><br />
                                </div>
		                        <div id="block" style="float: right">
                      
                                	<?php
                                	$arr = array("校園議題"=>"schoolnews", "升學考試"=>"exam","交換留學"=>"exchange","推薦知識"=>"knowledge","西灣故事"=>"story","社團活動"=>"clubsevent","工讀實習"=>"work");
