<?php
	...
	if( !isset($_SESSION['stu_id']) || !isset($_SESSION['name']) || !isset($_SESSION['auth']) || !isset($_SESSION['nick']) ) {
		...
		$query = "DELETE FROM chasing_list WHERE stu_id = '$stu_id' AND trade_id = '$trade'";
		$result = mysqli_query( $conn, $query ) or die('Delete Fail!');
		echo '<script type="text/javascript">alert("Delete Success!"); location.href="onChasing.php"</script>';
	}
?>