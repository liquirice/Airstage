<?php
	...
	function getSellerInfo( $userID, $conn ) {
		...
		if( $detail['name_c'] == "on" )       echo $detail['name'] . ' - ';
											  echo $detail['department'] . ' - ';
		if( $detail['grade_c'] == "on" ) 	  echo 'Grade ' . $detail['grade'] . '<br />';
		echo '</div>';
		
		// Image area.
		echo '<a href=\'' . $detail['facebook'] . '\' class=\'thumbnail\' target=\'_blank\'> <img src=\'../member/images/'. $detail['stu_id'] . '/member/' . $detail['profile_pic'] . '\'' . ' class=\'img-polaroid\' width=\'200px\' height=\'200px\' /> </a>';
	}
?>