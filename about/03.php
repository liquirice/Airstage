				...
				<table border="0" width="98%" cellspacing="0" cellpadding="0" height="525">
					<tr>
						...
						<table border="0" width="963" cellspacing="0" cellpadding="0" height="509">
						  <tr>
						    <td height="136" valign="top" align="right"><img src="../images/cry.png" alt="" width="82" height="11"><img src="bluesky.png" width="963" height="304" border="0" usemap="#Map" />
					        </td>
					      </tr>
						  <tr>
						    <td valign="middle">&nbsp;</td>
...
<map name="Map">
  ...
  <area shape="rect" coords="486,18,585,48" href="04.php" target="_parent">
