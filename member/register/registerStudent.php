...
<table border="0" width="45%" cellspacing="0" cellpadding="0" height="455">
					<tr>
						...
						<p align="center"><a href="registerLaw.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','jpg/b102.png',1)"><img src="jpg/b1.png" alt="使用條款" name="Image7" width="95" height="41" border="0"></a><img border="0" src="jpg/b203.png" width="95" height="41"><img border="0" src="jpg/b3.png" width="95" height="41"><a href="login.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('999','','jpg/b402.png',1)"><img src="jpg/b4.png" alt="會員登入" name="Image6" width="95" height="41" border="0"></a></td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;</td>
					</tr>
						...
						<div align="center">
							<table border="0" width="85%" cellspacing="0" cellpadding="0" height="389">
								...
								<tr>
									...
									<div><form method="post" action="makeNewAccount.php" id="form">
