	...
	if( isset($_POST['id']) ) {
		...
		if( mysqli_num_rows($result) == 0 ) {
			...
			if( $current == $direct ) {
				...
				$Redirect = 'Location: http://www.airstage.com.tw/member/register/login2.php?st=' . $row['stu_id'] . '&nm=' . $row['name'] . '&a=' . $row['AUTH'] . '&u=' . $row['username'];
				header( $Redirect );
			} else {
                                        ...
                                        <table border="0" width="45%" cellspacing="0" cellpadding="0" height="455">
                                            <tr>
                                                <td colspan="3" background="jpg/bar.png">
                                                    <p align="center"><font face="微軟正黑體"><a href="registerLaw.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image7','','jpg/c102.png',1)"><img src="jpg/c1.png" name="Image7" width="103" height="41" border="0"></a><a href="registerLaw.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','jpg/c202.png',1)"><img src="jpg/c2.png" name="Image6" width="103" height="41" border="0"></a><a href="#" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image5','','jpg/c302.png',1)"><img src="jpg/c3.png" name="Image5" width="103" height="41" border="0"></a><img src="jpg/c4.png" width="98" height="41"></font></p>
                                                </td>
                                            </tr>
