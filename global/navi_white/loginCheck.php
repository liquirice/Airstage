                ...
                <div class="notify">
                    ...
                    <table align="center" style="cursor:pointer; font:微軟正黑體" class="top" width="330px" cellpadding="0px" cellspacing="0px">
                        <tr height="45px">
                            ...
                            <td style="font-size:12px; font-weight:bold" align="left">'.$note2['source'].'</td>
        ...
        if($note["rno"] == $thenotify[$j]){
            ...
            $noteblock = '
                <div class="notify">
                    ...
                    <input type="hidden" value="'.$note2['rno'].'" class="rno" />
                    <table align="center" style="cursor:pointer; font:微軟正黑體" class="top" width="330px" cellpadding="0px" cellspacing="0px">
                        <tr height="45px"><td width="5px" rowspan="2"></td><td rowspan="2" width="40px"><img src="http://'.$_SERVER ['HTTP_HOST'].'/global/notifications/images/'.$pic.'.png" width="30px" height="29px" /></td><td style="font-size:12px; font-weight:bold" align="left">'.$note['source'].'</td><td style="color:#0099cc; font-size:12px;" align="right">'.$realnotetime.'</td><td width="20px"></td></tr>
                        <tr><td colspan="2" style="color:#666666; font-size:12px;" valign="top" align="left">'.CuttingStr($note["content"],30).'...</td></tr>
                    </table>
                </div>
            '.$noteblock;
...
*/
	echo '<a href="../../member/register/login.php" style="border:0 none; text-decoration:none; font-weight:700" id="login" width=330; height=400">
		...
		<a href="../../member/register/logout.php" style="border:0; color:#000000; font-size:14px; "><b>登出</b></a>
