...
<?php
	...
	echo '<a LANGUAGE="VBScript" TARGET="screen" onClick="screen.location.href =\'main.htm\'" href="member/login.php" style="border:0 none; text-decoration:none; font-weight:700" id="login" rel="shadowbox; width=330; height=350" title=\'會員登入\'>
		...
		//if( $_SESSION['nick'] != "" ) {
		//	echo '<a href="accounts/revises.php" style="border:0; color:#000000; font-size:14px"><b>'.$_SESSION['nick'].'</b></a>&nbsp;&nbsp;|&nbsp';
		//} else {
			echo '<a href="accounts/revises.php" style="border:0; color:#000000; font-size:14px"><b>'.$_SESSION['name'].'</b></a>&nbsp;&nbsp;|&nbsp';
		//}		
		echo '<a href="member/logout.php" style="border:0; color:#000000; font-size:14px"><b>登出</b></a>';
	}
