...
&nbsp;<table border="0" width="45%" cellspacing="0" cellpadding="0" height="453">
					<tr>
						...
						<p align="center"> <a href="register_law.php"><img border="0" src="jpg/b103.png" width="95" height="41"></a><img border="0" src="jpg/b2.png" width="95" height="41"><img border="0" src="jpg/b3.png" width="95" height="41"><a href="register_log.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image6','','jpg/b402.png',1)"><img src="jpg/b4.png" alt="會員登入" name="Image6" width="95" height="41" border="0"></a></td>
					</tr>
					<tr>
						<td colspan="3">&nbsp;</td>
					</tr>
						...
						<div align="center">
							<table border="0" width="85%" cellspacing="0" cellpadding="0" height="362">
								...
								<tr>
									...
									<p align="center">
									<textarea rows="14" name="S1" cols="35" style="border: 1px solid #C0C0C0"></textarea></td>
								</tr>
								<tr>
									<td height="45">
									<p align="center"><a href="register_choose.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('b','','jpg/bb102.png',1)"><img src="jpg/bb1.png" name="b" width="127" height="27" border="0"></a></td>
								</tr>
							</table>
						</div>
						</td>
